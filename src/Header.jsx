  ...
  return (
    <div className="bg-white flex justify-between py-2 items-center px-6">
      <div className="w-[10%] flex justify-start gap-6 items-center">
        <button className="text-gray-600 hover:bg-gray-300 rounded-full p-2">{MENU_BAR}   </button>
        <Logo />
      </div>
      ...
      <div className="flex w-[8%] justify-between items-center">
        <button className="text-gray-600 hover:bg-gray-300 rounded-full p-2">{VIDEO}</button>
        <button className="text-gray-600 hover:bg-gray-300 rounded-full p-2">{BELL}</button>
        <button className="text-black bg-gray-400 p-2 rounded-full">{USER}</button>
      </div>
    </div>
  );
};
